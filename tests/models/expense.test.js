...
describe('Expense Modal', () => {
    ...
    it('Should create an expense successfully', async () => {
        ...
        const savedExpense = await expense.save(); // Saves the expense.
    ...
    // Test case: Checks if an expense can be deleted successfully.
    it('Should delete an expense successfully', async () => {
        ...
        const savedExpense = await expense.save();
        await Expense.findByIdAndDelete(savedExpense._id); // Deletes the expense.

        const deletedExpense = await Expense.findById(savedExpense._id); // Gets the expense using the ID of the deleted expense.
        expect(deletedExpense).to.be.null; // Checks that the deleted expense is null which confirms deletion.
